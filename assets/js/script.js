...
$(function () {
  //dayjs to pull in date info and display at top of page
  ...
  //current hour for conditional coloring 
  var hour = dayjs().hour();
  //logic for conditional coloring
  $('.time-block').each(function(){
    var scheduleBlockHour = parseInt($(this).attr('id').split('-')[1])
    if (scheduleBlockHour === hour) {
      $(this).addClass('present');
    } else if (scheduleBlockHour > hour) {
